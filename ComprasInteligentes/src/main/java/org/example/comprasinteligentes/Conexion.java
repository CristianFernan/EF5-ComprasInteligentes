...
public class Conexion { // 00107223 Creacion de un singleton para la conexion con la base de datos
    ...
    private final String user = "JaviSimp05";// 00107223 Estableciendo el usuario que hara la conexion
    private final String password = "Chinameca5$"; // 00107223 Estableciendo la contraseña del usuario
