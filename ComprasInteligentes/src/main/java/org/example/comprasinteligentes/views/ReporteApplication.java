...
public class ReporteApplication extends Application { //00083723 Clase principal que extiende de Application para iniciar la aplicacion JavaFX
    ...
    public void start(Stage stage) throws IOException { // Funcion start que configura la ventana principal
        ...
        Scene scene = new Scene(fxmlLoader.load(), 750, 650); //00083723 Crea una nueva escena con el contenido cargado y establece sus dimensiones
        ...
        stage.setTitle("Reportes"); //00083723 Establece el titulo de la ventana
        stage.setResizable(false); //00083723 Evita que se le pueda cambiar las dimensiones a la pantalla
